...
boldface type.  The authors' name and affiliation appear below the title
...
Print your properly formatted text on high-quality, 8.5$\times$11-inch white printer
...
Since there are many ways, often incompatible, of including images (\eg, with
...
% the work by Jones \etal~\cite{C2} takes a different approach based on
